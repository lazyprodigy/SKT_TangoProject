...
public class HandController : MonoBehaviour {
  ...
  public bool b_isLeft = false;
  public bool b_isRight = false;
  ...
  */
  ...
  protected HandModel CreateHand(HandModel model) {
    ...
    ScriptManager.Instance.strChecker = "Appear!"; //: " + b_isLeft + " / " + b_isRight;
    //Debug.Log(model);
  ...
  */
  protected void DestroyHand(HandModel hand_model) 
  {
      ...
      ScriptManager.Instance.strChecker = "Delete!"; // : " + b_isLeft + " / " + b_isRight;
